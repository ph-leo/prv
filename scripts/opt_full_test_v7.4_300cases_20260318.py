...
生成时间: 2026-03-18
"""
# 使用说明：将此文件内容覆盖到 e:\ai_test_MedGemma\ai\other\scripts\full_test_v7.4_300cases.py

# 主要修改：
# 1. get_prompt 函数增加 doctor_diagnosis 参数
# 2. 根据 doctor_diagnosis 内容判断病种类型（优先级最高）
# 3. 修改调用处：get_prompt(body_part, doctor_diagnosis, use_v74=True)
