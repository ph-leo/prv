...
# 读取原脚本
f = open(r'e:\ai_test_MedGemma\ai\other\scripts\full_test_v7.4_300cases_backup_20260318.py', 'r', encoding='utf-8')
content = f.read()
f.close()
...
# 也替换调用处
content = content.replace('prompt, body_type = get_prompt(body_part)', 
...
print('修复完成！')
print('- 函数已修改为根据 doctor_diagnosis 判断病种')
print('- 调用处已更新')
print('- 文件已保存为 full_test_v7.4_300cases_opt_20260318.py')
